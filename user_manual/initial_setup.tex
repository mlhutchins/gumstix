...
\textbf{Note:} This service unit has already been set up to match the network information of the previous service unit with settings:
\begin{verbatim}
address:	132.234.86.195
gateway:	132.234.86.209
netmask:	255.255.255.0
DNS1: nameserver 132.234.1.1
DNS2: nameserver 132.234.250.10
MAC: 00:15:C9:28:FC:E3
SSH Port: 22
\end{verbatim}
